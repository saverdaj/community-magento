...
class Commercebug_Packager
{
    ...
    {
        $string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Jonsaverda_Commercebug><active>true</active><codePool>local</codePool></Jonsaverda_Commercebug></modules></config>';
        $string = str_replace('Jonsaverda_', $this->namespace . '_',$string);
