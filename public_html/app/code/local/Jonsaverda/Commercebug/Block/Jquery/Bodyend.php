...
*/
class Jonsaverda_Commercebug_Block_Jquery_Bodyend extends Jonsaverda_Commercebug_Block_Html
{
    public function getTabIdPairs()
    {
        $results = parent::getTabIdPairs();        
        if(!$this->is404())
        {
            unset($results['ascommercebug_404']);
        }
    ...
    */    
    ...
    {
        return Mage::getSingleton('commercebug/404_lint')->is404();
    }
