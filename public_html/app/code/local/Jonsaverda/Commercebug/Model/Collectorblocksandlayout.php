...
*/
class Jonsaverda_Commercebug_Model_Collectorblocksandlayout extends Jonsaverda_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Jonsaverda_Commercebug') === 0)
            {
                continue;
            }
