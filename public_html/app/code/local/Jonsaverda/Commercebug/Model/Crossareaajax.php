...
*/
abstract class Jonsaverda_Commercebug_Model_Crossareaajax
{
    ...
    */    
    ...
    {
        $controllers = array('Jonsaverda_Commercebug_AjaxController','Jonsaverda_Commercebug_AdminajaxController');
        ...
        foreach($controllers as $controller)
        {
            ...
            'Jonsaverda_Commercebug_Model_Crossareaajax','appendAction'), self::$_actionNames);
