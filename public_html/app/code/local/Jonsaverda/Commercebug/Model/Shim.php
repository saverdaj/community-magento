...
*/
class Jonsaverda_Commercebug_Model_Shim
{
    ...
    */    
    ...
    {
        $full_module_name = 'Jonsaverda_Commercebug';
    ...
    static public function getInstance()
    {
        if(!self::$_instance)
        {
            self::$_instance = new Jonsaverda_Commercebug_Model_Shim;
        }
